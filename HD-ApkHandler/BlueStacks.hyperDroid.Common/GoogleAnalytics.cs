...
namespace BlueStacks.hyperDroid.Common
{
    internal class GoogleAnalytics
    {
        ...
        private static string s_UserAgent = string.Format("Mozilla/5.0 (compatible; MSIE {0}; Windows NT {1}.{2})", "0.8.2.3018", Environment.OSVersion.Version.Major, Environment.OSVersion.Version.Minor);
