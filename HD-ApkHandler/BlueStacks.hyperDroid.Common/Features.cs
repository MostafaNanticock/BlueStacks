...
namespace BlueStacks.hyperDroid.Common
{
	public class Features
	{
		...
		{
			if (!Utils.IsOEMBlueStacks() && !Utils.IsOEM("Acer") && !Utils.IsOEM("AMD") && !Utils.IsOEM("Bstk") && !Utils.IsOEM("Bstkm") && !Utils.IsOEM("MSI") && !Utils.IsOEM("China") && !Utils.IsOEM("Lenovo"))
			{
				return false;
			}
			return true;
		...
		{
			if (!Utils.IsOEM("360") && !Utils.IsOEM("bigfish") && !Utils.IsOEM("wildtangent"))
			{
				return false;
			}
			return true;
