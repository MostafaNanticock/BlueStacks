...
namespace BlueStacks.hyperDroid.Common
{
    internal class GoogleAnalytics
    {
        ...
        private static string s_UserAgent = string.Format("Mozilla/5.0 (compatible; MSIE {0}; Windows NT {1}.{2})", "0.9.4.4078", Environment.OSVersion.Version.Major, Environment.OSVersion.Version.Minor);
