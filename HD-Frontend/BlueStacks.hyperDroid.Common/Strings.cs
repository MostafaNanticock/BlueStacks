...
namespace BlueStacks.hyperDroid.Common
{
	internal class Strings
	{
		...
		public static string LogCollectorLockName
		{
			get
			{
				return "Global\\BlueStacks_Log_Collector_Lock";
			}
		}
		...
		public static string ApkHandlerAlreadyRunning
		{
			get
			{
				return "An app is already being installed. Please wait while it finishes installing.";
			}
		}
		...
		public static string RegUpdaterPath
		{
			get
			{
				return "Software\\BlueStacks\\Updater";
			}
		}
		...
		public static string WebAppChannelClickStatsUrl
		{
			get
			{
				return "stats/webappchannelclickstats";
			}
		}
		...
		public static string ActivityEndedStatsUrl
		{
			get
			{
				return "stats/activityendedstats";
			}
		}
		...
		public static string HomeScreenStatsUrl
		{
			get
			{
				return "stats/homescreenstats";
			}
		}

		public static string VirtStatsUrl
		{
			get
			{
				return "stats/virt_stats";
			}
		}
		...
		public static string ChannelsProdUpdateUrl
		{
			get
			{
				return Strings.ChannelsProdUrl + "/checkupgrade";
			}
		}
		...
		public static string CDNAppSettingsUrl
		{
			get
			{
				return "http://cdn.bluestacks.com/public/appsettings/";
			}
		}
		...
		public static string WebPlayerUrl
		{
			get
			{
				return "http://bluestacks-wap.appspot.com/play";
			}
		}

		public static string UserActiveUrl
		{
			get
			{
				return "useractive";
		...
		public static string UpgradeNotSupported
		{
			get
			{
				return "Sorry.. This upgrade is not supported for the installed version.\n";
			}
		}
		...
		public static string UpgradeFromGingerbreadWarning1
		{
			get
			{
				return "NOTE: While we have taken utmost care to preserve your existing Apps and Data, some Apps may not work after the Upgrade. Please reinstall apps that fail to launch.\n";
			}
		}
		...
		public static string HyperVEnabledError
		{
			get
			{
				return "Unfortunately, BlueStacks (beta-1) cannot run on a PC where another virtualization software (VMWare/VirtualBox/Hyper-V) is active. Installation will now abort.";
			}
		}
		...
		public static string CommonAppData
		{
			get
			{
				...
				if (registryKey != null)
				{
					result = (string)registryKey.GetValue("UserDefinedDir");
				}
				return result;
			}
		}
		...
		public static string BstCommonAppData
		{
			get
			{
				string result = Path.Combine(Strings.CommonAppData, "BlueStacks");
				RegistryKey registryKey = Registry.LocalMachine.OpenSubKey("Software\\Bluestacks");
				if (registryKey != null)
				{
					result = (string)registryKey.GetValue("DataDir");
				}
				return result;
			}
		}
		...
		public static string BstAndroidDir
		{
			get
			{
				return Path.Combine(Strings.BstCommonAppData, "Android");
			}
		}
