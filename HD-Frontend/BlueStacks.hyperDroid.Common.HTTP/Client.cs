...
namespace BlueStacks.hyperDroid.Common.HTTP
{
    internal class Client
    {
        ...
        public static string Get(string url, Dictionary<string, string> headers, bool gzip, int timeout)
        {
            ...
            {
                Logger.Info("url = " + url);
                return Client.GetInternal(url, headers, gzip, timeout);
            }
            catch (Exception ex)
            {
        ...
        public static string GetInternal(string url, Dictionary<string, string> headers, bool gzip, int timeout)
        {
            ...
            Logger.Debug("URI of proxy = " + httpWebRequest.Proxy.GetProxy(destination));
            string text = null;
        ...
        public static string Post(string url, Dictionary<string, string> data, Dictionary<string, string> headers, bool gzip, int timeout)
        {
            ...
            {
                Logger.Info("url = " + url);
                return Client.PostInternal(url, data, headers, gzip, timeout);
            }
            catch (Exception ex)
            {
                if (url.Contains(Service.Host))
        ...
        public static string PostInternal(string url, Dictionary<string, string> data, Dictionary<string, string> headers, bool gzip, int timeout)
        {
            HttpWebRequest httpWebRequest = WebRequest.Create(url) as HttpWebRequest;
        ...
        public static string HTTPGaeFileUploader(string url, Dictionary<string, string> data, Dictionary<string, string> headers, string filepath, string contentType, bool gzip)
        {
            ...
            {
                Logger.Info("url = " + url);
                return Client.HTTPGaeFileUploaderInternal(url, data, headers, filepath, contentType, gzip);
            }
            catch (Exception ex)
            {
                if (url.Contains(Service.Host))
        ...
        public static string HTTPGaeFileUploaderInternal(string url, Dictionary<string, string> data, Dictionary<string, string> headers, string filepath, string contentType, bool gzip)
        {
            if (filepath == null)
            {
            ...
            return Client.HttpUploadFile(url2, filepath, "Prebundled", contentType, headers, data);
        }
        ...
        public static string HttpUploadFile(string url, string file, string paramName, string contentType, Dictionary<string, string> headers, Dictionary<string, string> data)
        {
            ...
            {
                Logger.Info("url = " + url);
                return Client.HttpUploadFileInternal(url, file, paramName, contentType, headers, data);
            }
            catch (Exception ex)
            {
                if (url.Contains(Service.Host))
        ...
        public static string HttpUploadFileInternal(string url, string file, string paramName, string contentType, Dictionary<string, string> headers, Dictionary<string, string> data)
        {
            ...
            Logger.Info("Reading Prebundled");
            ...
            {
                Logger.Error("Error uploading Prebundled", ex);
                if (webResponse != null)
                {
                    webResponse.Close();
                    webResponse = null;
